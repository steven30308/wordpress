...
$args['opt_name'] = 'bloggie';

//Custom menu icon
//$args['menu_icon'] = '';

//Custom menu title for options page - default is "Options"
$args['menu_title'] = __('Bloggie', 'nhp-opts');

//Custom Page Title for options page - default is "Options"
$args['page_title'] = __('Bloggie', 'nhp-opts');
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'sub_desc' => __('Upload your logo <strong>(188 x 70 px)</strong> using the Upload Button or insert image URL.', 'nhp-opts')
						),
					array(
						'id' => 'mts_favicon',
						'type' => 'upload',
...
$sections[] = array(
				...
				'fields' => array(
					array(
						...
						'sub_desc' => __('Groovy Theme comes with unlimited color schemes for your theme\'s styling.', 'nhp-opts'),
						'std' => '#FFA800'
						),
					array(
						'id' => 'mts_bg_color',
						...
						'sub_desc' => __('Pick any color using the <strong>color picker</strong>, or enter a hex color value in the input field to make it the background color for your theme. This setting is overriden if a background pattern is used.', 'nhp-opts')
						),
					array(
						'id' => 'mts_custom_css',
						'type' => 'textarea',
