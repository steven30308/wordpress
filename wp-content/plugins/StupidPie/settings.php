...
$spp_settings->url_rewrites = array( 
    'tag' => array('separator' => '-', 'rule' => 'archives/(.*)', 'index' => 1, 'permalink' => 'archives/{{ term }}' ), //0
    'random' => array('separator' => '-', 'rule' => '(.*)/(.*)\.html', 'index' => 2, 'permalink' => '{{ random }}/{{ term }}.html' ), //1
    'second_word' => array('separator' => '-', 'rule' => '(.*)/(.*)\.html', 'index' => 2, 'permalink' => '{{ first_word }}/{{ term }}.html' ), //2
    
    'index_image' => array('separator' => '-', 'rule' => 'archives/(.*)', 'index' => 1, 'permalink' => 'archives/{{ term }}' ),
    'single_image' => array('separator' => '-', 'rule' => 'images/(.*)', 'index' => 1, 'permalink' => 'images/{{ term }}' ), //3    
    
    
    'index_video' => array('separator' => '-', 'rule' => 'archives/(.*)', 'index' => 1, 'permalink' => 'archives/{{ term }}' ), //5
